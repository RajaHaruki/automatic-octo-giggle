var OneTrustStub = function (e) {
    ...
    var t, n, i, a, o, r, s, l, p, c, u, d, m, h, g, f, v, A, b, C, I, y, S, L, T, w, D, R, P, E, _, B, O, G, U, N, k, M, F, V, x, H, j, q, z, K, W, J, Y, Q, X, Z, $, ee, te, ne, ie, ae, oe, re, se, le, pe, ce, ue, de, me, he, ge, fe, ve, Ae, be, Ce, Ie, ye, Se, Le, Te, we, De, Re, Pe, Ee = new function () {
        this.optanonCookieName = "OptanonConsent",
            ...
            this.EUCOUNTRIES = ["BE", "BG", "CZ", "DK", "DE", "EE", "IE", "GR", "ES", "FR", "IT", "CY", "LV", "LT", "LU", "HU", "MT", "NL", "AT", "PL", "PT", "RO", "SI", "SK", "FI", "SE", "GB", "HR", "LI", "NO", "IS"], this.stubFileName = "otSDKStub", this.DATAFILEATTRIBUTE = "data-domain-script", this.bannerScriptName = "otBannerSdk.js", this.mobileOnlineURL = [], this.isMigratedURL = !1, this.migratedCCTID = "[[OldCCTID]]", this.migratedDomainId = "[[NewDomainId]]", this.userLocation = { country: "", state: "" }
    };
    (n = t = t || {

    }
    )[n.Unknown = 0] = "Unknown", n[n.BannerCloseButton = 1] = "BannerCloseButton",
        n[n.ConfirmChoiceButton = 2] = "ConfirmChoiceButton",
        n[n.AcceptAll = 3] = "AcceptAll",
        n[n.RejectAll = 4] = "RejectAll", n[n.BannerSaveSettings = 5] = "BannerSaveSettings",
        n[n.ContinueWithoutAcceptingButton = 6] = "ContinueWithoutAcceptingButton",
        (a = i = i || {})[a.Banner = 1] = "Banner", a[a.PC = 2] = "PC", a[a.API = 3] = "API", (r = o = o || {}).AcceptAll = "AcceptAll", r.RejectAll = "RejectAll", r.UpdateConsent = "UpdateConsent",
        (l = s = s || {})[l.Purpose = 1] = "Purpose",
        l[l.SpecialFeature = 2] = "SpecialFeature",
        (c = p = p || {}).Legal = "legal", c.UserFriendly = "user_friendly",
        (d = u = u || {}).Top = "top",
        d.Bottom = "bottom", (h = m = m || {

        }
        )[h.Banner = 0] = "Banner",
        h[h.PrefCenterHome = 1] = "PrefCenterHome",
        h[h.VendorList = 2] = "VendorList",
        h[h.CookieList = 3] = "CookieList", (f = g = g || {

        }
        )[f.RightArrow = 39] = "RightArrow",
        ...
        A.AfterDPD = "AfterDPD", (C = b = b || {

        }
        ).PlusMinus = "Plusminus",
        C.Caret = "Caret",
        C.NoAccordion = "NoAccordion",
        (y = I = I || {

        }
        ).Consent = "Consent",
        y.LI = "LI", y.AddtlConsent = "AddtlConsent",
        (L = S = S || {

        }).Iab1Pub = "eupubconsent",
        ...
        )[w.Disabled = 0] = "Disabled",
        w[w.Consent = 1] = "Consent",
        w[w.LegInt = 2] = "LegInt",
        (R = D = D || {

        }
        )[R["Banner - Allow All"] = 1] = "Banner - Allow All",
        ...
        (E = P = P || {}).Active = "1",
        E.InActive = "0", (B = _ = _ || {}).Host = "Host",
        B.GenVendor = "GenVen", (G = O = O || {})[G.Host = 1] = "Host",
        G[aG.GenVen = 2] = "GenVen",
        G[G.HostAndGenVen = 3] = "HostAndGenVen",
        (N = U = U || {})[N.minDays = 1] = "minDays",
        N[N.maxDays = 30] = "maxDays",
        N[N.maxYear = 31536e3] = "maxYear",
        N[N.maxSecToDays = 86400] = "maxSecToDays",
        (M = k = k || {})[M.RTL = 0] = "RTL", M[M.LTR = 1] = "LTR", (V = F = F || {})[V.GoogleVendor = 1] = "GoogleVendor",
        V[V.GeneralVendor = 2] = "GeneralVendor", (H = x = x || {})[H.Days = 1] = "Days", H[H.Weeks = 7] = "Weeks", H[H.Months = 30] = "Months", H[H.Years = 365] = "Years", (q = j = j || {}).Checkbox = "Checkbox",
        q.Toggle = "Toggle",
        (K = z = z || {}).SlideIn = "Slide_In",
        K.FadeIn = "Fade_In",
        K.RemoveAnimation = "Remove_Animation",
        (J = W = W || {}).Link = "Link",
        J.Icon = "Icon",
        ...
        ).update = "update", Z.default = "default",
        ...
        (ne = te = te || {}).granted = "granted", ne.denied = "denied",
        (ae = ie = ie || {

        }
        )[ae.HostList = 0] = "HostList",
        ae[ae.IabVendors = 1] = "IabVendors",
        ae[ae.VendorServices = 2] = "VendorServices",
        (re = oe = oe || {}).OBJECT_TO_LI = "ObjectToLI",
        re.LI_ACTIVE_IF_LEGAL_BASIS = "LIActiveIfLegalBasis",
        (le = se = se || {}).cookies = "cookies",
        le.vendors = "vendors",
        (ce = pe = pe || {

        }).GDPR = "GDPR",
        ce.IAB = "IAB", ce.CCPA = "CCPA",
        ce.IAB2 = "IAB2",
        ce.GENERIC = "GENERIC",
        ce.LGPD = "LGPD",
        ce.GENERIC_PROMPT = "GENERIC_PROMPT",
        ce.CPRA = "CPRA",
        ce.CDPA = "CDPA",
        ce.USNATIONAL = "USNATIONAL",
        ce.CUSTOM = "CUSTOM",
        (de = ue = ue || {

        }
        ).Name = "OTGPPConsent",
        de[de.ChunkSize = 4e3] = "ChunkSize"
    de.ChunkCountParam = "GPPCookiesCount",
        (he = me = me || {}).MspaCoveredTransaction = "IsMSPAEnabled",
        he.MspaOptOutOptionMode = "Opt-Out",
        he.MspaServiceProviderMode = "Service Provider",
        (fe = ge = ge || {

        }
        )
            .MspaCoveredTransaction = "MspaCoveredTransaction",
        fe.MspaOptOutOptionMode = "MspaOptOutOptionMode",
        fe.MspaServiceProviderMode = "MspaServiceProviderMode"
        , (Ae = ve = ve || {

        }
        )
            .SensitiveDataProcessing = "SensitiveDataProcessing",
        Ae.KnownChildSensitiveDataConsents = "KnownChildSensitiveDataConsents",
        (Ce = be = be || {
            ...
            .CPRA = "uspcav1",
        Ce.CCPA = "uspcav1",
        Ce.USNATIONAL = "uspnatv1",
        (ye = Ie = Ie || {

        }
        )
        [ye.CPRA = 8] = "CPRA", ye[ye.CCPA = 8] = "CCPA",
        ye[ye.USNATIONAL = 7] = "USNATIONAL",
        (Le = Se = Se || {})[Le.NotApplicable = 0] = "NotApplicable",
        Le[Le.OptOut = 1] = "OptOut",
        Le[Le.OptIn = 2] = "OptIn",
        (we = Te = Te || {})[we.NotApplicable = 0] = "NotApplicable",
        we[we.Yes = 1] = "Yes",
        we[we.No = 2] = "No",
        (Re = De = De || {})[Re.CmpId = 28] = "CmpId",
        Re[Re.CmpVersion = 1] = "CmpVersion"; var _e, Be, Oe, Ge, Ue = "geo",
            Ne = "otpreview",
            ke = (ue.Name,
                "PRODUCTION"),
            Me = ((Pe = {})[x.Days] = "PCenterVendorListLifespanDay",
                Pe[x.Weeks] = "LfSpnWk",
                Pe[x.Months] = "PCenterVendorListLifespanMonth",
                Pe[x.Years] = "LfSpnYr",
                Fe.prototype.camelize = function (e) {
        ...
        this.implementThePolyfill = function () {
            ...
            return Element.prototype.setAttribute = function (e, t) {
                if ("style" !== e.toLowerCase() && o.apply(this, [e, t]),
                    "style" !== e.toLowerCase() || t || this.removeAttribute("style"),
                    "style" === e.toLowerCase() && t) {
    ...
    function Ve(e, t, n) {
        ...
        var o = i(e.getAttribute("style")),
            r = i(t), a = ""; a = n && o ? function () {
                for (var e = o.split(";").concat(r.split(";")).filter(function (e) {
                    return 0 !== e.length
                }
                ),
                    t = "", n = "", i = e.length - 1; 0 <= i; i--) {
                    var a = e[i].substring(0, e[i].indexOf(":") + 1).trim(); t.indexOf(a) < 0 && (t += a, n += e[i] + ";")
                }
                return n
            }
    ...
    (Be = _e = _e || {
        ...
        Be[Be.ALWAYS_ACTIVE = 1] = "ALWAYS_ACTIVE",
        Be[Be.EXPIRED = 2] = "EXPIRED",
        Be[Be.NO_CONSENT = 3] = "NO_CONSENT",
        Be[Be.OPT_OUT = 4] = "OPT_OUT",
        Be[Be.PENDING = 5] = "PENDING",
        Be[Be.WITHDRAWN = 6] = "WITHDRAWN",
        (Ge = Oe = Oe || {}).ping = "ping",
        Ge.addEventListener = "addEventListener",
        Ge.removeEventListener = "removeEventListener",
        Ge.hasSection = "hasSection",
        Ge.getSection = "getSection",
        Ge.getField = "getField",
        Ge.getGPPData = "getGPPData";
    var xe = new function () {
        var r = this;
        this.LOCATOR_NAME = "__gppLocator",
            ...
            this.init = function () {
                r.win.__gpp && "function" == typeof r.win.__gpp || (r.win.__gpp = r.executeGppApi, window.addEventListener("message",
                    r.messageHandler, !1),
                    r.addFrame(r.LOCATOR_NAME))
            }
